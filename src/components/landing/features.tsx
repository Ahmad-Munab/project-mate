                            ...
                            <div className="space-y-4">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-slate-700 dark:text-slate-200">
                                                ...
                                                velocity, I recommend splitting
                                                the authentication feature into
                                                3 smaller tasks:
                                            </p>
                                ...
                                <div className="p-3 bg-slate-100 dark:bg-slate-700/50 rounded-lg">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-slate-700 dark:text-slate-200">
                                                I noticed potential conflicts in
                                                the API integration branch.
                                ...
                                <div className="p-3 bg-teal-50 dark:bg-teal-900/30 rounded-lg border border-teal-100 dark:border-teal-800/50">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-slate-700 dark:text-slate-200">
                                                I&apos;ve generated test cases
                                                for the new API endpoints based
                                                on your documentation. Would you
                                                like to review them?
                                            </p>
                                        </div>
                                    </div>
            ...
            >
                <div>
                    ...
                    <p className="text-lg text-slate-600 dark:text-slate-300">
                        Our AI assistant understands your project context, team
                        dynamics, and development patterns to provide
                ...
                <div className="space-y-4 mt-6">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 dark:text-slate-300">
                                The AI analyzes your project requirements and
                                automatically suggests optimal task divisions
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 dark:text-slate-300">
                                Get contextual recommendations based on your
                                actual codebase, not generic advice that
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 dark:text-slate-300">
                                Forecast project timelines, identify potential
                                bottlenecks, and get early warnings about risks
                                before they impact your delivery schedule.
                            </p>
                        </div>
                    </div>
                </div>
